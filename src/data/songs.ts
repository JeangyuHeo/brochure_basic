...
const songs: Song[] = [
  ...
  },
  {
    ...
    musical: "디어 에반 핸슨",
    tags: ["희망", "위로", "공동체", "감동"],
    songDescription: "디어 에반 핸슨의 대표곡으로, 혼자가 아니라는 메시지를 전하는 감동적인 넘버입니다. 에반의 거짓말로 시작된 콘너 머피 프로젝트가 많은 사람들에게 희망과 위로가 되어가는 과정을 그립니다. '당신은 결코 혼자가 아니며, 반드시 누군가가 당신을 찾아낼 것'이라는 강력한 메시지를 전달하는 뮤지컬의 하이라이트 곡입니다."
  }
];
