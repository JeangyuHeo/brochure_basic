...
const songs: Song[] = [
  ...
  // --- 공연 순서(2025) 추가 곡 ---
  {
    ...
    songDescription: "이갈린다와 엘파바가 같은 기숙사에 배정받은 후, 너무 다른 서로의 모습에 혼란스러운 감정을 표현하는 곡. 새침한 갈린다, 솔직한 엘파바가 처음엔 극혐하지만 서서히 다가가게 되는 뒷이야기를 생각하며 보시길 바랍니다."
  },
  {
    id: 1002,
  ...
  },
  {
    ...
    songDescription: "이집트 암네리스 공주가 화려함과 사치스러움을 보여주며, 자신의 아름다운 옷이 최고의 무기라고 노래하는 경쾌한 노래. 철부지 공주가 강한 자기애를 보여주면서도 화려함 속에 불안함을 가리고자 하는 이면을 엿볼 수 있는 곡입니다."
  },
  {
    id: 1006,
  ...
  },
  {
    ...
    songDescription: "미나가 드라큘라를 두려워 하면서도 사랑하게 되는 자신의 감정을 어찌할바 몰라 괴로워하는 마음을 표현하는 곡, 자유를 원하지만 드라큘라에게 벗어날 수 없음을 느끼는 슬픔과 혼란스러움을 표현했습니다."
  },
  {
    id: 1020,
